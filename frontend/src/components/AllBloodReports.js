                                    ...
                                    <div className="out1">
                                        ...
                                        <div className="card" id="num">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <td><button className="btn update" style={{ background: "#26CDD1", color: "white" }}><a href={"/updateBlood/" + rep._id}>Update</a></button></td>
                                                <td ><button className="btn delete" style={{ background: "#E53D3D", color: "white" }}><a href={"/deleteBlood/" + rep._id}>Delete</a></button></td>
