...
import dc from "../patientImages/dc.jpeg";
                ...
                <div
                    ...
                    <table className="table table-striped table-hover" id="myTable" >
                        <thead>
                            ...
                            <br /><center><div>
                                <input type="text" className="search form-control" placeholder="Search by Name" onChange={handleFilterChange} style={{ margin: "0", width: "300px" }} />
                            </div></center>
