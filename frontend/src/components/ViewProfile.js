            ...
            <center>
                <div>
                    ...
                    <table>
                        ...
                        <center><ReactPrint trigger={() => <button type="button" class="btn text-white mt-2" style={{ background: "#2F4FAA", width: "150px", height: "40px" }}>Print</button>} content={() => ref.current} /></center><br /><br /><br /><br />
                    </table>
                </div>
                <td></td>
            </center>
