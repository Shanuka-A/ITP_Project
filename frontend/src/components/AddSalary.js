                                        ...
                                        <div className="row g-0">
                                            <div className="col-lg-12">
                                                <div className="p-5">
                                                    ...
                                                    <div>
                                                        <div className="col-md-12 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                <input type="text" id="form3Examplev2" className="form-control form-control-lg" onChange={function (e) { setname(e.target.value) }} />
                                                        ...
                                                        <div className="col-md-12 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                <input type="text" id="form3Examplev2" className="form-control form-control-lg" onChange={function (e) { setbasicsalary(e.target.value) }} />
                                                        ...
                                                        <div className="col-md-12 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                <input type="text" id="form3Examplev3" className="form-control form-control-lg" onChange={function (e) { setcompletedhours(e.target.value) }} />
                                                        ...
                                                        <div className="col-md-12 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                <input type="text" id="form3Examplev2" className="form-control form-control-lg" onChange={function (e) { setOTsalary(e.target.value) }} />
                                                    ...
                                                    <button type="button" className="btn btn-light btn-lg" style={{ background: "#E53D3D", width: "100px" }} onClick={() => navigate("/readSalary")}>Cancel</button>
