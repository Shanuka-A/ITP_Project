                    ...
                    <div className="container py-5 h-100">
                        <div className="row d-flex justify-content-center align-items-center h-100">
                            <div className="col-12">
                                <div className="card card-registration card-registration-2" style={{ borderRadius: "50px" }}>
                                            ...
                                            <div className="col-lg-12">
                                                <div className="p-5">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                ...
                                                                <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" onChange={function (e) { setGender(e.target.value) }} required>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-4 mb-4 pb-2">
                                                            ...
                                                            <div className="form-outline">
                                                                ...
                                                                <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" onChange={function (e) { setBlood(e.target.value) }} required>
                                                    ...
                                                    <br /><div className="row d-flex justify-content-center">
                                                        <button type="submit" class="btn btn-success btn-lg mt-3 mr-2" style={{ background: "#26CDD1", width: "100px" }} onClick={submit}>Register</button><br />
                                                        <button type="button" class="btn btn-danger btn-lg mt-3" style={{ background: "#E53D3D", width: "100px" }} onClick={() => navigate(-1)}>Cancel</button>
                                                    </div>
