            ...
            <button type="button" id="model-btn-unsuccess" data-toggle="modal" data-target="#exampleModalCenter-un"></button>*/}
                ...
                <br /><form className="container create-form border border-info rounded p-3 d-up-form" style={{ borderRadius: "50px" }}>
                    ...
                    <br /><div class="row d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn btn-success btn-lg mt-3" style={{ background: "#26CDD1", width: "100px" }} onClick={btnClick}>Update</button>
                        <button type="button" class="btn btn-secondry btn-lg mt-3" style={{ background: "#afafaf", width: "100px" }} onClick={() => navigate(-1)}>Cancel</button>

                    </div><br />
                    <button type="button" class="btn btn-danger btn-lg mt-3" style={{ background: "#E53D3D", width: "100px" }} onClick={() => navigate("/deletePatient/" + id)}>DELETE</button>
